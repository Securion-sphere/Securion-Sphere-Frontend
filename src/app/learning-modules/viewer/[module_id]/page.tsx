...
const PDFViewer = dynamic(() => import('@/components/viewer/PDFViewer'), {
  ssr: false,
  loading: () => <div className="w-full h-96 flex items-center justify-center">Loading PDF viewer...</div>
});

// Dynamically import Markdown viewer
const MarkdownViewer = dynamic(() => import('@/components/viewer/MarkdownViewer'), {
  ssr: false,
  loading: () => <div className="w-full h-96 flex items-center justify-center">Loading Markdown viewer...</div>
});
